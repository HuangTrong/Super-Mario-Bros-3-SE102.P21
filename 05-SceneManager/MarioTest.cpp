...
CMarioTest::CMarioTest(float x, float y) {
	this->x = x;
	this->y = y;
	this->stop_x = x;
	this->stop_y = y;
...
void CMarioTest::Update(DWORD dt) {
...
void CMarioTest::SetState(int state) {
...
void CMarioTest::GoTo(float x, float y)
{
